...
{ 
  ...
  if (isset($_SESSION['session_libtype'])) { // si connecté
      echo "<td><a href='modifier.php?num=".$row['email_util']."'><img src='img/tableau/edit.pn'></a><a href='supprimer.php?num=".$row['email_util']."'><img src='img/tableau/delete.pn'></a></td>"; 
  }
  }
  echo "</tr>"; 
echo "</table>";
